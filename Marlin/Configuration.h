...
#define STRING_CONFIG_H_AUTHOR "(Ender-2)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 2 Stock
  #define  DEFAULT_bedKp 111.00
  #define  DEFAULT_bedKi 20.22
  #define  DEFAULT_bedKd 152.30
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE - 26)
...
// The stock display that comes with the CREALITY Ender-2 
// IMPORTANT: The cable must be connected to EXP1 but reversed (rotated 180deg) - the header direction tab will need to be removed from the header to do so.
//            Black wire is 5V, white wire is GND
